package com.de180293.pe_sba301_sp25_be_de180293.utils;
...
public class JwtUtil {
    ...
    public String generateAccessToken(String memberId, Role role) {
        return buildToken(memberId, role, "access", accessExpiresMillis);
    }

    public String generateRefreshToken(String memberId, Role role) {
        return buildToken(memberId, role, "refresh", refreshExpiresMillis);
    }

    private String buildToken(String memberId, Role role, String type, long expiresMillis) {
